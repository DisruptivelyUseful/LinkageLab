// ============================================================================
// LINKAGE LAB — Undo / redo history
// Depends on global: state, idMap, syncUI, requestRender, showToast, drag, debounce
// ============================================================================
...
(function () {
    ...
    window.LinkageModules.history = { saveStateToHistory, undo, redo };
})();
